...
from .handlers import MaterialDetailsHandler, MaterialSearchHandler, SearXNGSearchHandler, BatteryHandler, SemiconductorHandler, AlloyHandler
...
# Kani wrapper
# --------------------------------------------------------------------------------------
class MPKani(MaterialDetailsHandler, MaterialSearchHandler, SearXNGSearchHandler, BatteryHandler, CalPhadHandler, SemiconductorHandler, AlloyHandler, Kani):
    def __init__(
        self,
