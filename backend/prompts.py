...
KANI_SYSTEM_PROMPT = (
    ...
    "   - get_material_by_char: Search by properties (band gap, stability, magnetism, etc.)\n"
    ...
    "Q: 'Crystal structure of X' → get_material or get_material_details_by_ids\n"
    "Q: 'Band gap of X' → get_material_by_char with band_gap parameter\n"
